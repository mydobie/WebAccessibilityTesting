...
export const checks = [
  ...
  'There is at least a 3 : 1 contrast ratio or other visual indicator between states',
];

const ResetLinkColor = styled.div`
  a {
    color: #0d6efd; /* Bootstrap's original link color */
  }
`;
          ...
          <Col>
            ...
            >
              <p>
                ...
                Roseville, near the Como Park and Saint Anthony Park
            ...
            >
              <p>
                ...
                glass-walled refrigerator as a 90-pound (41 kg) block of butter
                is carved into a head with her likeness. Butter makers started
                sculpting their products at the fair as far back as 1898,
                although the head-sculpting tradition did not begin until 1964.
              </p>
            </TestingAlert>
        ...
        <Row className='mb-4'>
          <Col>
            ...
            <p>
              ...
              reference to the expansion of railroads in Minnesota, towns
              popping up across the state like gophers. For these reasons,
              Minnesota is sometimes referred to as the gopher state. Fairchild,
              the original mascot, was suggested in a statewide contest by
              Gladys Anderson Brown in 1966 in honor of Henry S. Fairchild who
              advocated using the former Ramsey County Poor Farm as the
              permanent site of the fair.
            </p>
          </Col>
